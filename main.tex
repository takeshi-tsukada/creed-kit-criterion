...
\begin{abstract}
    The (bi)category of profunctors can be seen as a categorification of the relational model of linear logic.
    The profunctor interpretation of a \( \lambda \)-term concides with the Taylor expansion in the profunctor model 
