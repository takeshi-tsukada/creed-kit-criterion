...
\begin{abstract}
    ...
    The profunctors definable by \( \lambda \)-terms are known to have a certian property on their symmetry actions, the property which makes the matrix representation of profunctors functorial.
    The symmetry actions of the interpretations have also been studied in terms of creeds and kits.
    This paper addresses the converse question: how precisely the functoriality of the matrix representations, creeds or kits characterise the interpretations.
